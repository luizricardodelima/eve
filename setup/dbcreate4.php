...
function create_database_4($screenname, $password)
{
	...
	$mysqli->query ("INSERT INTO `{$pref}settings` (`key`, `value`) VALUES ('certification_email_body_html', '<p>Voc&ecirc; tem um novo certificado dispon&iacute;vel em&nbsp;\$system_name:</p>\r\n<p><strong>\$certification_name</strong></p>\r\n<p>Para acessar e baixar o certificado, acesse&nbsp;<a href=\"\$site_url\">\$site_url</a>,&nbsp;com seu&nbsp;e-mail e senha cadastrados.</p>\r\n<p>Se encontrar dificuldades, entre em contato conosco no e-mail \$support_email_address.</p>');");
	$mysqli->query ("INSERT INTO `{$pref}settings` (`key`, `value`) VALUES ('certification_email_subject', 'Novo certificado dispon&iacute;vel - \$system_name');");
	$mysqli->query ("INSERT INTO `{$pref}settings` (`key`, `value`) VALUES ('certification_send_email_on_update', '1');");
	...
	$mysqli->query ("INSERT INTO `{$pref}settings` (`key`, `value`) VALUES ('payment_send_email_on_update', '1');");
	...
	$mysqli->query ("INSERT INTO `{$pref}settings` (`key`, `value`) VALUES ('submission_revision_email_body', '<p>Sua submiss&atilde;o enviada em \$system_name foi avaliada</p>\r\n<p><strong>Detalhes da submiss&atilde;o</strong></p>\r\n<p>\$submission_content</p>\r\n<p><strong>Avalia&ccedil;&atilde;o</strong></p>\r\n<p>\$revision_content</p>\r\n<p>Para mais informa&ccedil;&otilde;es,&nbsp;entre em \$site_url com seu e-mail (\$email) e senha cadastrados. Caso n&atilde;o saiba sua senha, acesse a op&ccedil;&atilde;o \"esqueci minha senha\".</p>\r\n<p>Para outras d&uacute;vdas, entre em contato atrav&eacute;s do e-mail \$support_email_address.</p>');");
	$mysqli->query ("INSERT INTO `{$pref}settings` (`key`, `value`) VALUES ('submission_revision_email_send', '1');");
	$mysqli->query ("INSERT INTO `{$pref}settings` (`key`, `value`) VALUES ('submission_revision_email_subject', 'Avalia&ccedil;&atilde;o de submiss&atilde;o conclu&iacute;da - \$system_name');");
